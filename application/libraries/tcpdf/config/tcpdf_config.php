 ...
 */
define ('PDF_HEADER_LOGO', 'coopmart.png');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'TOKO OMI COOP MART MINIMARKET');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Coop Mart Al-Muawanah UIN Alauddin Makassar\nwww.coopmart.id");
